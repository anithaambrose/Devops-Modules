...
### Bucket Type:
  ...
  * Directory - recommended for low latency, fast processing of data use case, supports **only Single AZ storage class** such as *Express one Zone & one Zone infrequent*.
