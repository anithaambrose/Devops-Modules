...
CloudFront is a AWS web service that **speed up distribution** of your static & dynamic web content such as .html,.css, .js, image files to your users.

CloudFront delivers your content through a **worldwide network of data centers** called *edge locations* to enforce *low latency & faster response*.
