...
Overall, IAM is an essential component of AWS security
- providing granular control over access to your AWS account and resources.
- reducing the risk of unauthorized access.
- helping maintain a secure environment.
...
Groups: IAM groups are collections of users with similar access requirements. 
